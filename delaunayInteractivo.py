...
class Triangulo(Figura):
    ...
    def figura(self):
        ...
        glColor3f(uniform(1,256)/256.0,uniform(1,256)/256.0,uniform(1,256)/256.0)
...
def legalize(arista,t,listaTriangulos,Q,listaQ):
    ...
    if(test == "out"):
        ...
        legalize([p1, vOp],nuevoT1,listaTriangulos,Q,listaQ)
...
def agregar(punto,listaTriangulos,Q,listaQ):
    ...
    if(posicion == "in"):
        ...
        anti(nuevoT2)
        anti(nuevoT3)
        #Añadir colores a los triangulos
    ...
    while run:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                y = 600-y
                if((20<x and x<580) and (20<y and y<580)):
                    punto = Vector(x,y)
                    agregar(punto,listaTriangulos,Q,listaQ)
